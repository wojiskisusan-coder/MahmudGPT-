        ...
        <div className="p-6 text-center">
          ...
          {redeemed ? (
            <div className="py-8">
              ...
              <p className="text-sm text-muted-foreground">Enjoy lifetime unlimited access 🎉</p>
            </div>
          ) : (
            <>
              {reason === "limit" ? (
                <>
                  ...
                  <p className="text-xs text-muted-foreground mb-5">Upgrade to Pro for unlimited access and advanced AI capabilities.</p>
                </>
              ) : (
                <>
                  <h2 className="text-xl font-bold font-['Space_Grotesk'] mb-1 gradient-text">Unlock Pro Features</h2>
                  <p className="text-xs text-muted-foreground mb-5">This feature requires a Pro plan. Unlock the full power of MahmudGPT.</p>
                </>
              )}
                ...
                <div className="mb-5 space-y-3 animate-in fade-in slide-in-from-bottom-2">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      maxLength={10}
                      className="flex-1 h-10 px-3 rounded-xl bg-accent/20 border border-border/30 text-sm text-foreground placeholder:text-muted-foreground/40 outline-none focus:border-primary/50 focus:shadow-[0_0_12px_hsl(var(--primary)/0.1)] transition-all font-mono tracking-wider text-center"
                      autoFocus
                    />
                    <Button
                  ...
                  <button onClick={() => setShowReferral(false)} className="text-[10px] text-muted-foreground/50 hover:text-muted-foreground transition-colors">
                    Cancel
                  </button>
                </div>
              ) : (
